...
namespace WindowsFormsApp1
{
    public partial class Form2 : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            System.IO.StreamReader file = new System.IO.StreamReader(Environment.CurrentDirectory + "\\" + tst + ".txt");
            ...
            label3.Text = TestGila[0].Intrebare;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                intrebare_curenta++;
                label3.Text = TestGila[intrebare_curenta].Intrebare;
