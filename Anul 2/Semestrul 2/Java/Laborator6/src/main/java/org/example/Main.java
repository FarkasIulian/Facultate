...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Optional<LocalDate> minim = angajatList
                .stream()
                .map(Angajat::getData_angajarii)
                .min(LocalDate::compareTo);
        minim.ifPresentOrElse((x) -> {
            angajatList
                    .stream()
                    .filter((a) -> {
                        if (a.getData_angajarii().compareTo(minim.get()) == 0)
                            return true;
                        return false;
                    })
                    .forEach(System.out::println);
            System.out.println("Data primei angajari: " + x);
        ...
        angajatList
                ...
                .findAny()
                .ifPresentOrElse((i) -> System.out.println("Firma contine cel putin un Ion")
